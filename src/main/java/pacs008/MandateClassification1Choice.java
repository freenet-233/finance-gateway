 ...
 * 
 * <p>MandateClassification1Choice complex type的 Java 类。
 * 
...
@XmlType(name = "MandateClassification1Choice", namespace = "urn:iso:std:iso:20022:tech:xsd:pacs.008.001.10", propOrder = {
    "cd",
    "prtry"
})
