 ...
 * 
 * <p>Charges7 complex type的 Java 类。
 * 
 ...
 *         &lt;element name="Agt" type="{urn:iso:std:iso:20022:tech:xsd:pacs.008.001.10}BranchAndFinancialInstitutionIdentification6"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "Charges7", namespace = "urn:iso:std:iso:20022:tech:xsd:pacs.008.001.10", propOrder = {
    "amt",
    "agt"
})
public class Charges7 {
    ...
    @XmlElement(name = "Agt", namespace = "urn:iso:std:iso:20022:tech:xsd:pacs.008.001.10", required = true)
