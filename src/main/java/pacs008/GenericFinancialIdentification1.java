 ...
 *         &lt;element name="SchmeNm" type="{urn:iso:std:iso:20022:tech:xsd:pacs.008.001.10}FinancialIdentificationSchemeName1Choice" minOccurs="0"/>
...
@XmlType(name = "GenericFinancialIdentification1", namespace = "urn:iso:std:iso:20022:tech:xsd:pacs.008.001.10", propOrder = {
    "id",
    "schmeNm",
    "issr"
})
